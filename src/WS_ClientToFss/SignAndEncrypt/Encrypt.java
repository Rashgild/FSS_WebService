...
public class Encrypt {
    ...
    public  static Document StartEncrypt(X509Certificate cert , String nameFile) throws Exception
    {
        ...
        FileInputStream is = new FileInputStream(GlobalVariables.PathToSave[1]+nameFile); // ЕСЛИ берем из файла
    ...
    public static SOAPMessage CreateXMLAndEncrypt(SOAPMessage soapMessage, String nameFile)
        ...
        org.w3c.dom.Document doc = StartEncrypt(Certificate.ExtractCertFromCertStore(), nameFile);
