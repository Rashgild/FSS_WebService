...
*/
 private static SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
    protected static PrParseFileLnLpu CreateFrame(String SQLreq, String SQLreq2) throws Exception {

        int primaryFlag=0;
        ResultSet resultSet = SQLConnect.SQL_Select(SQLreq);
        ResultSet resultSet2 = SQLConnect.SQL_Select(SQLreq2);

        List<ROW> rows = new ArrayList<>();

        while (resultSet.next()) {
            String ELN = resultSet.getString("LN_CODE");
            int per = 3;
            ...
            if ( (ln_result.getMseresult() != null && !ln_result.getMseresult().equals(""))
                ...
                ln_result.setAttribId("ELN_"+ELN+"_2_doc");
            }
            ...
            primaryFlag =  row.getPrimaryflag();
